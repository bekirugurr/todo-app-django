...
class TodoForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'priority': forms.Select(attrs={'class': 'input-style', 'style' : 'padding: .5rem 1rem; border-color: #0D6EFD; width: 16rem'}),
            
            'tag': forms.TextInput(attrs={'placeholder': '🔖 Enter task tag ', 'class': 'input-style', 'style' : 'padding: .5rem 1rem; border-color: #0D6EFD; width: 16rem'}),
        }
